...
class JudgeSpider(scrapy.Spider):
    ...
    start_urls = ['http://judgment.judicial.gov.tw/FJUD/default.aspx']
    ...
    def __init__(self,id=''):
        ...
        dict_key = ['id','name','age','fatherName', 'motherName','currentAdddress','companyAddress','residenceAddress','source']
    ...
    def parse_case(self, response):
        ...
        if len(response_list) == 0:
            ...
            keywords = ['本票裁定','支付命令' ,'協商認可','詐欺','洗錢防制法','給付簽帳卡', '槍砲彈藥',\
                '定其應執行刑','毒品', '藥事法', '賭博案','消費者債務清理','拋棄繼承','更生事件','消債之前置協商認可事件']
                    ...
                    for k in keyman:
                        ...
                        # initialize item
                            ...
                            if event_age >= 20 :
                                ...
                                if (self.lender_info['residenceAddress'] != '') and (self.lender_info['residenceAddress'][:6] in text):
                                    
                                    items['map_address'] = '是'
                                elif (self.lender_info['currentAdddress'] != '') and (self.lender_info['currentAdddress'][:6] in text):
